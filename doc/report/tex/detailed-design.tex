...
Questo andamento sequenziale e periodico è stato modellato attraverso una composizione di textbf{state monad} (per quanto riguarda l’aggiornamento della struttura del mondo) e di textbf{IO monad} (per le operazioni di I/O come il display a video delle entità e delle statistiche storiche alla chiusura dell’applicazione).
...
\subsection{Queriable type class e ad-hoc polimorphism}
