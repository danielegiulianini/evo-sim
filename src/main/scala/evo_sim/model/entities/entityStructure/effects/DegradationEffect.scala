...
object DegradationEffect{
  ...
  /**
   * Standard degradation effect for [[evo_sim.model.entities.entityStructure.EntityStructure.Living]] entities.
   ...
   * @tparam A the entity is a subtype of [[evo_sim.model.entities.entityStructure.EntityStructure.Living]].
   ...
   * @param blob the degradation effect will be applied to this blob [[evo_sim.model.entities.Entities.PoisonBlob]].
   * @return the life with the new value decreased.
   */
